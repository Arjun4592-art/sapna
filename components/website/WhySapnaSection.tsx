...
export default function AboutSection(): JSX.Element {
  return (
    <section
      id='about'
      className='section bg-bg-surface border border-rose-100 rounded-2xl
    ...
    >
      ...
      <div className='mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center relative z-10'>
        {/* Avatar col */}
          ...
          <div className='relative mb-5'>
            ...
            <div
              className='relative h-36 w-36 sm:h-40 sm:w-40 rounded-full
                            ...
                            hover:shadow-[var(--shadow-soft)] hover:border-gold-300 hover:scale-[1.04]
        ...
        <div className='animate-[slideInRight_0.6s_cubic-bezier(0.4,0,0.2,1)_both]'>
          ...
          <h2 className='font-serif text-ink-900 text-2xl sm:text-3xl leading-[1.2] mt-2 mb-4'>
