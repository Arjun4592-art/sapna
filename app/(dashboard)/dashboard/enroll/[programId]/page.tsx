    ...
    <div className='max-w-2xl mx-auto space-y-6'>
      ...
      {alreadyEnrolled ? (
        ...
        <div className='card text-center py-12 space-y-4'>
          <div
            className='w-14 h-14 rounded-full bg-green-50
                          flex items-center justify-center mx-auto'
          >
            <CheckIcon size={24} className='text-green-500' strokeWidth={2.5} />
          </div>
          ...
          <div className='card space-y-5'>
            ...
            <div className='flex items-start justify-between'>
              <div>
                <span className='badge badge-rose text-[10px] mb-2 inline-block'>
                  {programId === '8-week' ? '8-Week' : '4-Week'} Program
                </span>
            ...
            <div className='flex flex-wrap items-center justify-center gap-4 pt-2'>
              {TRUST_SIGNALS.map((t) => (
                ...
                >
                  <ShieldIcon size={12} className='text-rose-400' />
                  {t}
                </div>
              ))}
            </div>
