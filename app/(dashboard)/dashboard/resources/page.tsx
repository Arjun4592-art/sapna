...
const TYPE_CONFIG: Record<string, TypeConfig> = {
  ...
  audio: {
    icon: AudioIcon,
    color: 'bg-burgundy-50 text-burgundy-400',
    label: 'Audio',
  },
  video: { icon: VideoIcon, color: 'bg-gold-50 text-gold-500', label: 'Video' },
  link: { icon: GlobeIcon, color: 'bg-green-50 text-green-600', label: 'Link' },
}
            ...
            className={`px-4 py-2 rounded-full text-xs font-semibold
                        ...
                        ${
                          filter === f
                            ...
                            : 'bg-bg-surface text-ink-500 border-ink-100 hover:border-rose-400'
                        }`}
          >
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div className='flex-1 min-w-0'>
                    <div className='flex items-start justify-between gap-2'>
                      ...
                      {!unlocked && (
                        <span
                          className='text-[10px] bg-amber-50 text-amber-600
