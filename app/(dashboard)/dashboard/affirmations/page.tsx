    ...
    <div className='space-y-6 stagger-children'>
      ...
      <div className='card bg-burgundy-700 border-burgundy-700 relative overflow-hidden'>
        ...
        <div className='relative z-10 flex items-center gap-2 mb-3'>
          <span className='text-rose-300 animate-[float_2.5s_ease-in-out_infinite]'>
            <SparkleIcon size={14} />
          </span>
            ...
            {a.isCustom ? (
              <button
                ...
                className='absolute top-3 right-3 w-6 h-6 rounded-full
                           bg-rose-50 text-rose-400 flex items-center justify-center
