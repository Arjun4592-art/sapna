...
const STATUS_COLORS: Record<string, string> = {
  scheduled: 'bg-gold-50 text-gold-600 border-gold-200',
  completed: 'bg-green-50 text-green-600 border-green-200',
  cancelled: 'bg-red-50 text-red-500 border-red-200',
}

const PROGRAM_NAMES: Record<string, string> = {
  '4-week': 'Soul Blueprint',
            ...
            return (
              ...
              >
                <div className='flex items-start gap-4'>
                  {/* Date block */}
                  <div
                    className='w-14 h-14 rounded-xl bg-rose-50 flex flex-col
                                  items-center justify-center shrink-0'
                  >
                    <span className='text-[10px] font-bold text-rose-400 uppercase leading-none'>
                    ...
                    {s.zoomLink && s.status === 'scheduled' && (
                      <a
                        ...
                        className='inline-flex items-center gap-1.5 mt-3
                                   ...
                                   bg-rose-50 px-3 py-1.5 rounded-full
