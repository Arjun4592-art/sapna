    ...
    <div className='space-y-6'>
      ...
      {programs.length === 0 ? (
        <div className='card flex flex-col items-center justify-center py-16 gap-3'>
          <BookIcon size={40} className='text-rose-100' />
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          {programs.map((p) => (
            <div key={p.id} className='card-hover relative'>
              ...
              >
                <button className='w-8 h-8 flex items-center justify-center rounded-lg border border-ink-100 text-ink-400 hover:border-rose-300 hover:text-rose-400 transition-all duration-150 bg-bg-surface'>
                  <PenIcon size={13} />
                </button>
              </Link>
              ...
              {/* Module count */}
              <div className='flex items-center gap-2 pt-3 border-t border-rose-100'>
