    ...
    <div className='space-y-6'>
      ...
      {sessions.length === 0 ? (
        <div className='card flex flex-col items-center justify-center py-16 gap-3'>
          <CalendarIcon size={40} className='text-rose-100' />
        ...
        <div className='card p-0 overflow-hidden'>
          <div className='overflow-x-auto'>
            <table className='w-full text-sm'>
              <thead>
                <tr className='border-b border-rose-100 bg-bg-muted'>
                    ...
                    >
                      ...
                      <td className='px-5 py-4'>
                        <div className='flex items-center gap-3'>
                          <div className='w-9 h-9 rounded-xl bg-rose-50 flex flex-col items-center justify-center flex-shrink-0'>
                      ...
                      <td className='px-5 py-4'>
                        <span
                          className={`text-[11px] font-semibold px-2.5 py-1 rounded-full border capitalize ${STATUS_COLORS[s.status] || 'bg-gray-50 text-gray-500 border-gray-200'}`}
                        >
                          {s.status}
                        </span>
                      </td>
                      ...
                      <td className='px-5 py-4'>
                        <div className='flex items-center gap-2'>
                          <Link href={`/admin/sessions/${s.id}/edit`}>
                            <button className='w-8 h-8 flex items-center justify-center rounded-lg border border-ink-100 text-ink-400 hover:border-rose-300 hover:text-rose-400 transition-all duration-150'>
                              <PenIcon size={13} />
                            </button>
                          </Link>
                          <button
                            ...
                            className='w-8 h-8 flex items-center justify-center rounded-lg border border-ink-100 text-ink-400 hover:border-red-300 hover:text-red-500 transition-all duration-150 disabled:opacity-40'
                          >
                            {deleting === s.id ? (
                              <svg
