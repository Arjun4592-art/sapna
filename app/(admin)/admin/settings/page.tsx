...
export default function SettingsPage(): JSX.Element {
  ...
  return (
    <div className='space-y-8 max-w-2xl animate-fade-up'>
          ...
          <div className='relative flex-shrink-0'>
            ...
            <button
              ...
              className='absolute -bottom-1 -right-1 w-7 h-7 rounded-full
                         ...
                         hover:bg-burgundy-700 transition-colors duration-150 shadow-md'
            >
              <CameraIcon size={13} />
            </button>
            <input
          ...
          <div key={field.name}>
            ...
            <div className='relative'>
              ...
              <input
                ...
                style={{
                  paddingLeft: '44px',
                  paddingRight: field.name === 'confirm' ? '44px' : undefined,
                }}
      ...
      <div
        style={{ borderRadius: '6px' }}
        className='card border-red-200 space-y-4'
      >
        <div className='flex items-center gap-2'>
          <AlertIcon size={18} className='text-red-400' />
          <h2 className='font-serif text-base font-semibold text-red-500'>
            Danger Zone
          </h2>
        </div>
