...
const PROGRAMS: ProgramOption[] = [
  { id: '4-week', label: 'Soul Blueprint Intensive (4-Week)', weeks: 4 },
  { id: '8-week', label: 'Soul Awakening: Empowered You (8-Week)', weeks: 8 },
]

const TOTAL_WEEKS: Record<string, number> = { '4-week': 4, '8-week': 8 }
...
export default function StudentDetailPage({
  ...
  const [selectedProg, setSelectedProg] = useState<string>('4-week')
    ...
    <div className='space-y-6 max-w-3xl animate-fade-up'>
      ...
      <div style={{ borderRadius: '6px' }} className='card'>
        <div className='flex items-start gap-4'>
          <div className='w-16 h-16 rounded-full bg-rose-100 flex items-center justify-center flex-shrink-0 overflow-hidden'>
            {student?.photo ? (
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div style={{ borderRadius: '6px' }} className='card space-y-4'>
          ...
          {/* Enroll form */}
          {showEnroll && (
            <div className='p-3 bg-rose-50/60 border border-rose-100 rounded-sm space-y-3'>
              <select
            ...
            <div className='space-y-3'>
              {enrollments.map((e) => {
                ...
                return (
                  <div
                    key={e.id}
                    className='p-3 bg-rose-50/60 border border-rose-100 rounded-sm'
                  >
                ...
                return (
                  <div
                    ...
                    className='flex items-center gap-3 p-2.5 rounded-sm
                               hover:bg-rose-50/40 transition-colors duration-150'
                  >
                    <div className='w-10 h-10 rounded-sm bg-rose-50 flex flex-col items-center justify-center flex-shrink-0'>
