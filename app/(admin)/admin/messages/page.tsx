    ...
    <div className='space-y-6'>
      ...
      <div className='page-header'>
        ...
        <p className='page-desc'>
          ...
          {unread > 0 ? (
            <span className='text-rose-400 font-medium'>{unread} unread</span>
          ) : (
            'all read'
          )}
        </p>
        ...
        <div className='lg:col-span-1 space-y-2'>
          {messages.length === 0 ? (
            <div className='card flex flex-col items-center justify-center py-12 gap-3'>
              <MailIcon size={32} className='text-rose-100' />
              ...
              <div
                ...
                className={[
                  ...
                  selected?.id === msg.id
                    ...
                    : 'border-ink-100 bg-bg-surface hover:border-rose-300 hover:bg-bg-muted',
                ].join(' ')}
              >
                <div className='flex items-start gap-3'>
                  ...
                  <div
                    className={[
                      ...
                      msg.read ? 'bg-ink-100' : 'bg-rose-400',
                    ].join(' ')}
                  />
        ...
        <div className='lg:col-span-2'>
          {!selected ? (
            <div className='card flex flex-col items-center justify-center py-20 gap-3'>
              <MailOpenIcon size={36} className='text-rose-100' />
            ...
            <div className='card space-y-6'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                {[
                  ...
                  <div
                    key={label}
                    className='p-3 bg-bg-muted border border-rose-100 rounded-xl'
                  >
              ...
              <div>
                ...
                <p className='text-sm text-ink-700 leading-relaxed whitespace-pre-wrap bg-bg-muted border border-rose-100 rounded-xl p-4'>
                  {selected.message}
                </p>
              </div>
