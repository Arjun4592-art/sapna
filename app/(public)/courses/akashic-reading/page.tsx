  ...
  return (
    ...
    >
      ...
      {/* <nav className='relative z-50 border-b border-white/10 backdrop-blur-md'
        style={{ background: 'rgba(13,5,33,0.8)' }}>
        <div className='max-w-5xl mx-auto px-6 py-4 flex items-center justify-between'>
          <Link href='/' className='flex items-center gap-2.5'>
            <div className='w-7 h-7 rounded-full flex items-center justify-center'
              style={{ background: 'rgba(155,111,212,0.3)', border: '1px solid rgba(196,160,232,0.4)' }}>
              <SparkleIcon size={13} className='text-[#C4A0E8]' />
            </div>
          ...
          <div className='flex items-center gap-3'>
            <Link href='/#programs'
              className='text-xs text-[#8B7BA8] hover:text-[#C4A0E8] transition-colors'>
              ← All Programs
            </Link>
            <RazorpayButton
              programId='4-week'
              ...
              style={{
                background: 'linear-gradient(135deg, #6B2FA0, #9B6FD4)',
                boxShadow:  '0 4px 20px rgba(155,111,212,0.4)',
              } as any}
            />
          </div>
        </div>
      ...
      >
        ...
        >
          <RazorpayButton
            programId='4-week'
            label='Begin Your Cosmic Journey — ₹5,999'
      ...
      >
        <CosmicLabel>The 4-Week Journey</CosmicLabel>
        <h2
          className='text-white text-center mb-12'
          style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic' }}
        >
          Week by week, <span style={{ color: '#C4A0E8' }}>star by star</span>
        </h2>
